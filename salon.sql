...
INSERT INTO public.appointments VALUES (2, 2, 5, '3');
...
INSERT INTO public.customers VALUES (2, '333-3333', 'Noah');
...
--
-- Name: appointments fk_customers_appointments; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fk_customers_appointments FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);
